# Here we implement DEEP Q LEARNING
# In this code, we have implemented TIC TAC TOE Game using DEEP Q LEARNING
# The ACCURACY of this method is VERY HIGH.
...
class AIPlayer(Player):
    ...
    # let's evaluate a given state: so update the Q(s,a) table regarding s state and an action
